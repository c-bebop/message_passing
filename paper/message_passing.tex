...
\noindent There are other primitives than the above mentioned to provide the functionality of \gls{tcp} \cite[ch. 4.3.1 on p. 141]{tanenbaum}. The referenced book \cite{tanenbaum} provides useful and valuable information on this topic.\\
...
\noindent The middleware can also perform some preparatory work e.g. separating stand-alone request strings and parsing them into a data structure and returning this data – which is more easily to parse – when calling the receive routine of the message passing middleware.\\
